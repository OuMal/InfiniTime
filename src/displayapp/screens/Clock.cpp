...
#include "displayapp/screens/WatchFaceLM.h"
...
std::unique_ptr<Screen> Clock::WatchFaceLMScreen() {
  return std::make_unique<Screens::WatchFaceLM>(app,
                                                     dateTimeController,
                                                     batteryController,
                                                     bleController,
                                                     notificatioManager,
